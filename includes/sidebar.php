      ...
      <ul class="list-unstyled component text-light">
        <li class="active mb-1">
          ...
          <ul class="collapse list-unstyled pl-2" id="categories">
            <li>
              <a class="text-light" href="/cms/includes/data/categories/categories.php">View all categories</a>
            </li>
            <!-- <li>
              <a class="text-light" href="/cms/includes/data/categories/categories.php?action=categories">Add category</a>
            </li> -->
            <li>
          ...
          <a href="#posts" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle text-light text-uppercase font-weight-bold">Posts</a>
            <ul class="collapse list-unstyled pl-2" id="posts">
              <li><a class="text-light" href="/cms/includes/data/posts/posts.php">View all posts</a></li>
              <li><a class="text-light" href="/cms/includes/data/posts/posts.php?action=addpost">Add post</a></li>
            </ul>
          </li>
        </li>
      </ul>
